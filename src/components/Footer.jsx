const Footer = () => {
  return (
    <footer className="bg-violet-200 py-14 px-2">
      <div className="screen-max-width flex flex-col sm:items-start justify-between sm:flex-row text-white gap-6">
        <div className="md:min-w-52 flex flex-col sm:items-start items-center">
        ...
        <div className="flex flex-col gap-2 sm:items-start items-center">
          ...
          <ul className="text-violet-100 text-sm flex flex-col gap-1 sm:items-start items-center">
            <li className="hover:text-cyan transition cursor-default">
              Link Shortening
            </li>
            <li className="hover:text-cyan transition cursor-default">
              Branded Links
        ...
        <div className="flex flex-col gap-2 sm:items-start items-center">
          <h4 className="font-semibold text-md">Resources</h4>
          <ul className="text-violet-100 text-sm flex flex-col gap-1 sm:items-start items-center">
            <li className="hover:text-cyan transition cursor-default">Blog</li>
            <li className="hover:text-cyan transition cursor-default">
              Developers
            </li>
            <li className="hover:text-cyan transition cursor-default">
        ...
        <div className="flex flex-col gap-2 sm:items-start items-center">
          ...
          <ul className="text-violet-100 text-sm flex flex-col gap-1 sm:items-start items-center">
            <li className="hover:text-cyan transition cursor-default">About</li>
            <li className="hover:text-cyan transition cursor-default">
              Our Team
            </li>
            <li className="hover:text-cyan transition cursor-default">
